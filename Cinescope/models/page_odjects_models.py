...
#         notification_locator = self.page.get_by_text("Неверная почта или пароль")
#         notification_locator.wait_for(state="visible")
#         assert notification_locator.is_visible() == True
...
class PageAction:
    ...
    @allure.step("Проверка всплывающего сообщения об ошибке логинa")
    def check_error_allert(self)-> bool:
